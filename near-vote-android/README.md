...
4. 참여자 기기에 투표 영수증이 표시되는지 확인합니다.
5. 제안자 기기의 `게시한 투표` 화면에서 집계가 갱신되는지 확인합니다.
6. 제안자 기기에서 `결과 공유하기`를 눌러 참여자 기기에 결과가 표시되는지 확인합니다.
7. 설문 화면이 늦게 뜨면 제안자 기기에서 `참여 요청 다시 보내기`를 누릅니다.
